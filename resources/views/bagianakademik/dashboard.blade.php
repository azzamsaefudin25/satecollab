...
<head>
    ...
    <style>
        ...
        .btn-green {
            background-color: #658345; /* Warna hijau yang sama dengan header */
        ...
        .btn-green:hover {
            background-color: #567539; /* Warna hijau sedikit lebih gelap untuk efek hover */
        }
        .btn2 {
    ...
    <div class="content-wrapper">
        <div class="sidebar">
            ...
            <div class="button-grid">
                <button class="btn-green" onclick="window.location.href='{{ route('penyusunanruang.index') }}'">
                    Penyusunan Ruang Perkuliahan
                </button>
                <button class="btn-green" onclick="window.location.href='{{ route('pengalokasianruang.index') }}'">
