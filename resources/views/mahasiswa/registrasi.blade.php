...
<div class="content-wrapper">
    ...
    <div class="main-content">
        <h1 class="text-start mb-5">REGISTRASI</h1>
        <div class="row">
            <!-- Kartu Aktif -->
            <div class="col-md-6">
                <div class="card">
                    <h5>AKTIF</h5>
                    <img src="https://via.placeholder.com/80" alt="Profile Aktif">
                    <button class="btn-status-active mt-3">Sudah Mengisi</button>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <h5>CUTI</h5>
                    <img src="https://via.placeholder.com/80" alt="Profile Cuti">
                    <button class="btn-status-inactive mt-3">Tidak Tersedia</button>
                </div>
            </div>
        </div>

        <div class="riwayat-pembayaran mt-5">
            <h5><i class="bi bi-receipt"></i> Riwayat Pembayaran</h5>
        </div>
    </div>
</div>
