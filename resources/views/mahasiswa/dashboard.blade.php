    ...
    <div class="content-wrapper">
        <div class="sidebar">
            ...
            <div class="student-performance">
                ...
                <p>IPK: {{ Auth::user()->mahasiswa->ipk ?? 'N/A' }}</p>
                <p>SKS: 79</p>
            </div>
        ...
        <div class="main-content">
            <div class="status-section">
                <div class="status-details">
                    ...
                    <p><strong>Status Akademik </strong><button type="button"
                            class="btn btn-light btn-sm">AKTIF</button></p>
                </div>
            </div>

            <div class="button-grid">
                <button type="button2" class="btn btn-outline-success btn-lg"
                    onclick="window.location.href='{{ route('mahasiswa.registrasi') }}'">Registrasi</button>
                <button type="button2" class="btn btn-outline-success btn-lg"
                    onclick="window.location.href='{{ route('jadwal.index') }}'">Jadwal Perkuliahan</button>
                <button type="button2" class="btn btn-outline-success btn-lg"
                    onclick="window.location.href='{{ route('irs.create') }}'">Pengisian
                    IRS</button>
                <button type="button2" class="btn btn-outline-success btn-lg"
                    onclick="window.location.href='{{ route('mahasiswa.khs') }}'">KHS</button>
            </div>
        </div>
    </div>
