...
<body>
        ...
        <div class="content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><button class="button button1">Batalkan Persetujuan</button>
        </div>
        </td>
        <td><button class="button button1" onclick="window.location.href='{{route('lihatirs')}}'">Lihat</button></td>
        </tr>
        <tr>
            <td>2</td>
            <td>240601221....</td>
    ...
    <tr>
        ...
        <td><button class="button button1">Lihat</button></div>
        </td>
        <td><button class="button button1">Lihat</button></td>
    </tr>
    <tr>
        ...
        <td><span class="approved">Sudah Mengisi</span></td>
        <td><button class="button button1">Ditolak</button></div>
        </td>
        <td><button class="button button1">Lihat</button></td>
    </tr>
    </table>
